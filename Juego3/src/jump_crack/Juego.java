...
public class Juego extends JPanel {
	...
	//objetos de las clases, toro, nino y fondo
	Nino nino = new Nino(this);
	Toro toro = new Toro(this);
	...
	public Juego() { 
		direccionSonidoChoque=getClass().getResource("/media/choque.wav");
		sonidoChoque= Applet.newAudioClip(direccionSonidoChoque);
		
		direccionSonidoSalto=getClass().getResource("/media/salto.wav");
	...
	public void dibujarPuntaje(Graphics2D g) {
		...
		if (juegoFinalizado) {
			...
			g2.drawString("¡¡¡ Haz Perdido el amor de ella !!!", ((float)getBounds().getCenterX()/2)+170,70);
