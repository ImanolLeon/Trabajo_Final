 ...
 */
package com.enciclopedia.juegouno.Methods;

import com.enciclopedia.juegouno.Frame.Principal;
...
public class Utilities {
    ...
    public void paintImage(JButton btn, int value) {
        try {
            btn.setIcon(new ImageIcon(System.getProperty("user.dir") + "/juegouno/src/main/java/com/enciclopedia/juegouno/Images/0" + value + ".png"));
